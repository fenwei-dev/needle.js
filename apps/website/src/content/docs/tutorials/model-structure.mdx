...
Now that the operators are familiar, inspect how they are serialized in the [`.cact` archive](/tutorials/cact-format/), then build a minimal [loader and tokenizer](/tutorials/engine-1-loader/).
</Aside>
